...
- There are no memlog / uv / python scripts, config files, or file paths to run or read — treat every such instruction as internal bookkeeping you simply skip, and keep the session's memory in your own context instead of a file.
